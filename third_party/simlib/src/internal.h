...
#define SIMLIB_IMPLEMENTATION                                                                           \
    _Pragma("GCC diagnostic push")                                                                      \
        _Pragma("GCC diagnostic ignored \"-Wunused-variable\"") static int SIMLIB_module_num =          \
            SIMLIB_module_id.Init("(" __FILE__ ", SIMLIB-" SIMLIB_VERSION DEBUG_INFO ", " SIMLIB_SYSTEM \
                                  "/" SIMLIB_COMPILER ", " __DATE__ " " __TIME__ ")");                  \
...
class AlgLoopDetector {
    ...
    void unlock() { block->TestAndSetFlag(false, SimObject::_EVAL_FLAG); }
