...
//
Function1::Function1(Input i, double (*pf)(double)) : aContiBlock1(i), f(pf) { Dprintf(("Function1::Function1(in)")); }
...
//
Function2::Function2(Input i1, Input i2, double (*pf)(double, double)) : aContiBlock2(i1, i2), f(pf) {
