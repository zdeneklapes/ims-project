...
begin_step:
    ...
    for (ip = FirstIntegrator(), i = 0; ip != end_it; ip++, i++) {
        ...
        (*ip)->SetState((*ip)->GetOldState() - 11.0 / 54.0 * A1[i] + 2.5 * A2[i] - 70.0 / 27.0 * A3[i] +
                        35.0 / 27.0 * A4[i]);
    }
    ...
    for (ip = FirstIntegrator(), i = 0; ip != end_it; ip++, i++) {
        ...
        (*ip)->SetState((*ip)->GetOldState() + 1631.0 / 55296.0 * A1[i] + 175.0 / 512.0 * A2[i] +
                        575.0 / 13824.0 * A3[i] + 44275.0 / 110592.0 * A4[i] + 253.0 / 4096.0 * A5[i]);
    }
    ...
    for (ip = FirstIntegrator(), i = 0; ip != end_it; ip++, i++) {
        ...
        (*ip)->SetState((*ip)->GetOldState() + 37.0 / 378.0 * A1[i]  // final state
                        + 250.0 / 621.0 * A3[i] + 125.0 / 594.0 * A4[i] + 512.0 / 1771.0 * A6[i]);
    }
    ...
    for (ip = FirstIntegrator(), i = 0; ip != end_it; ip++, i++) {
        ...
        eerr = fabs(-277.0 / 64512.0 * A1[i]  // estimation
                    + 6925.0 / 370944.0 * A3[i] - 6925.0 / 202752.0 * A4[i] - 277.0 / 14336.0 * A5[i] +
                    277.0 / 7084.0 * A6[i]);
