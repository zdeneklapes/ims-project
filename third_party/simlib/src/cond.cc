...
//
aCondition::aCondition() : Next(First) { First = this; }
...
void aCondition::InitAll() {
    ...
    for (aCondition *i = First; i; i = i->Next) i->Init();
}
...
void aCondition::SetAll() {
    for (aCondition *i = First; i; i = i->Next) i->SetNewStatus();
}
...
//
Condition::Condition(Input i) : in(i), cc(0), ccl(0) {}
...
//
void Condition::Init() { cc = ccl = 0; }

////////////////////////////////////////////////////////////////////////////
// Condition::SetNewStatus -- set new status of condition
//
void Condition::SetNewStatus() { ccl = cc; }
