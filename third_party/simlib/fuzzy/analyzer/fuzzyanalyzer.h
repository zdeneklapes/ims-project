 ...
 * @ingroup xml
 */
class FuzzyData : public AnalyzedData {
   public:
    /**
     ...
     */
    FuzzyData() : cl(false), in1(NULL), in2(NULL), out(NULL), fset(NULL) { setReleasable(true); }
    /**
     ...
     */
    FuzzyData(FuzzySet* set) : cl(false), in1(NULL), in2(NULL), out(NULL), fset(set) { setReleasable(true); }
...
class FuzzyHandler : public DefaultHandler {
   public:
    ...
    virtual void setDocumentLocator(const Locator* const locator) { this->locator = locator; }
