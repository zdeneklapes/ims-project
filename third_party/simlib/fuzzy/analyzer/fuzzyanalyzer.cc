 ...
 */
AnalyzedData* FuzzyAnalyzer::getAnalyzedData() { return data; }
...
void FuzzyHandler::startElement(const XMLCh* const uri, const XMLCh* const localname, const XMLCh* const qname,
...
void FuzzyHandler::error(const SAXParseException& e) {
    fSawErrors = true;
    errors++;
    cerr << "\nError at file " << StrX(e.getSystemId()) << ", line " << e.getLineNumber() << ", char "
...
void FuzzyHandler::fatalError(const SAXParseException& e) {
    fSawErrors = true;
    fatalErrors++;
    cerr << "\nFatal Error at file " << StrX(e.getSystemId()) << ", line " << e.getLineNumber() << ", char "
         << e.getColumnNumber() << "\n  Message: " << StrX(e.getMessage()) << endl;
}
...
void FuzzyHandler::warning(const SAXParseException& e) {
    warnings++;
    cerr << "\nWarning at file " << StrX(e.getSystemId()) << ", line " << e.getLineNumber() << ", char "
         << e.getColumnNumber() << "\n  Message: " << StrX(e.getMessage()) << endl;
}
