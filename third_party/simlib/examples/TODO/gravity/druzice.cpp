...
struct Planet : public MassPoint {
    const double radius;
    Planet(const double m, Position p, const double r) : MassPoint(m, p), radius(r) {}
};
...
struct Satelite : public MassPoint {
   private:
    ...
    class xAcceleration : public aContiBlock {  // blok vìpoŸtu zrychlen¡
       ...
       public:
        xAcceleration(MassPoint &mp) : p(mp) {}
    } ax;
    class yAcceleration : public aContiBlock {  // blok vìpoŸtu zrychlen¡
       ...
       public:
        yAcceleration(MassPoint &mp) : p(mp) {}
    } ay;
   ...
   public:
    ...
    Satelite(double m, Position p0, Speed v0 = Speed(0, 0))
        : MassPoint(m, p0), ax(*this), ay(*this), vx(ax, v0.x), vy(ay, v0.y), x(vx, p0.x), y(vy, p0.y) {}
};
